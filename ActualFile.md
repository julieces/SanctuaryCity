...
#**UNHCR**
```
- center: [21.3890, 39.8579]
- zoom: 12
L.marker([21.3890, 39.8579]).actions.addRemove(S.map)
```
...
```
- center: [52.4234, 13.0452]
- zoom: 12
L.marker([52.4234, 13.0452]).actions.addRemove(S.map)
```
This part is about Berlin.
![Germany](https://i1.wp.com/socialscienceworks.org/wp-content/uploads/2016/12/image4.jpg?resize=1024%2C768)
